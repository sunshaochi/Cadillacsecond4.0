 ...
 */
public class BreakpointUploadTask {
    private OSS oss;
    private BreakpointUploadRequest request;
    private OSSCompletedCallback<BreakpointUploadRequest, BreakPointUploadResult> callback;
    ...
    public BreakpointUploadTask(OSS oss, BreakpointUploadRequest request, OSSCompletedCallback<BreakpointUploadRequest, BreakPointUploadResult> callback) {
        this.oss = oss;
    ...
    public void upload(String uploadId) throws ClientException, ServiceException, IOException {
        ...
        try {
            ...
            final OSSProgressCallback<BreakpointUploadRequest> progressCallback = request.getProgressCallback();
                ...
                uploadPart.setProgressCallback(new OSSProgressCallback<UploadPartRequest>() {
                    ...
                    public void onProgress(UploadPartRequest request, long currentSize, long totalSize) {
                        ...
                        if (progressCallback != null) {
                            progressCallback.onProgress(BreakpointUploadTask.this.request, currentUploadLength + currentSize, fileLength);
                        }
                    }
                });
            ...
            BreakPointUploadResult result = new BreakPointUploadResult(completeResult);
