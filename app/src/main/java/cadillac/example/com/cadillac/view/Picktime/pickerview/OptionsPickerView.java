...
import cadillac.example.com.cadillac.view.Picktime.view.BasePickerView;
import cadillac.example.com.cadillac.view.Picktime.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
	...
	public OptionsPickerView(Context context) {
		...
		customTitle = (RelativeLayout) findViewById(R.id.custom_title);
		// -----确定和取消按钮
