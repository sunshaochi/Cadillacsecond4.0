...
public class NewLmJdFra extends BaseFrag {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        getMacluom(CadillacUtils.getCurruser().getUserName(),"1",inputTimeid,dateid);//获取mac裸车毛利绝对值
    ...
    private void setJiemianData(List<Map<String, Object>> res) {
       ...
       /* 全国父容器*/
        if (res.size() > 0) {
            ...
            getRegional(qgflag,"全国",inputTimeid,"1",ll_maclmqg);//获取大区
        }
                            ...
                            dqview.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if(dqview.getTag().toString().equals(pos +"")) {
                                        ...
                                        getMaclist(dqflag,parm.getName(),inputTimeid,"1",maclin,dqview);//得到大区数据和大区list
                            ...
                            macview.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if(macview.getTag().toString().equals(pos+"")) {
                                        String obj = map.get("经销商").toString().replace("code=","").replace(",","");
                                        LmJxsBean parm =GsonUtils.gsonToBean(obj,LmJxsBean.class);
                                        getjxslist(macflag,parm.getName(),inputTimeid, "1",jxslin,macview);//获取mac下的经销商列表（显示各个经销商）
                                    }else {
                                        macview.setTag(pos);
