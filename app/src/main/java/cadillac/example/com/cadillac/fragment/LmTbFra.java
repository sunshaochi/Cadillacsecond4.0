...
public class LmTbFra extends BaseFrag{
...
//                                        String parm = obj.split(",")[0].split("=")[1];
                                        ...
                                        getMaclist(dqflag,parm,inputTimeid,"3",maclin,lin);//得到大区数据和大区list
...
//                                        String macname=parm.substring(0,parm.length()-1).toString();
                                        ...
                                        getjxslist(macflag,parm,inputTimeid, "3",jxslin,lin);//获取mac下的经销商列表（显示各个经销商）
                                    }else {
                                        lin.setTag(pos);
